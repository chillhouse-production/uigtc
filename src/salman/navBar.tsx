        ...
        <div className="max-w-[2000px] mx-auto px-4 sm:px-6 lg:px-8 border-l border-r border-[#3d2314]/30 bg-white shadow-md">
          <div className="flex items-center justify-between h-16">
            <div className="flex-shrink-0">
              <img src={LogoBulat} alt="UIGTC Logo" className="h-12 w-auto" />
            </div>
              ...
              {isLoggedIn ? (
                <div className="relative">
                  ...
                  >
                    ...
                    <svg className={`h-4 w-4 transition-transform duration-200 ${showDropdown ? 'rotate-180 text-white' : 'text-gray-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
